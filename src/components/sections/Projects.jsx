  ...
  const projects = [
    {
      ...
      description: "Personal Portfolio Website showcasing all the needed information for any company or person in order to consider hiring me.",
    ...
    },
    {
      ...
      description: "A responsive website showcasing Gautam Steelworks' products and services.",
